    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                @endphp
                <a href="{{ Route('acc.calculations.share.print', $month) }}" class="btn btn-sm btn-secondary"
                    target="_blank"><i class='bx bx-printer'></i> Print</a>
                <div class="dateRange text-end">
                    <form action="{{ Route('accounts.calculations.share') }}" method="GET">
                        ...
                        <div class="border mx-auto p-0">
                            ...
                            <div class="card-body overflow-auto overflow-lg-unset">
                                <table class="table table-striped table-hover table-bordered">
                                    ...
                                    <tfoot>
                                        <tr class="{{ $allincomes['cards'] - $totalExpence > 0 ? 'bg-success' : 'bg-danger' }} text-light"
                                            style="font-size: 24px;">
                                            <td colspan="2" class="text-end" style="border-top: 1px solid"><b>সর্বশেষ
                                                    হিসাবঃ</b></td>
                                            <td style="border-top: 1px solid">
                                                <b>{{ $allincomes['cards'] - $totalExpence }}/-</b>
                                            </td>
                                        </tr>
                                        <tr class="{{ ($allincomes['cards'] - $totalExpence) / $shareQuantity->share_quantity > 0 ? 'bg-success' : 'bg-danger' }} text-light"
                                            style="font-size: 24px;">
                                            <td colspan="2" class="text-end" style="border-top: 1px solid"><b>প্রতি
                                                    শেয়ার</b></td>
                                            <td style="border-top: 1px solid">
                                                <b>{{ ($allincomes['cards'] - $totalExpence) / $shareQuantity->share_quantity }}/-</b>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
